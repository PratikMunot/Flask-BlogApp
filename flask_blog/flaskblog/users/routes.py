...
@users.route('/register',methods=['GET','POST']) # this means that we are now accepting GET and POST request to our current route
def register():
    ...
    if form.validate_on_submit():
        ...
        db.session.add(user)
        db.session.commit()
        flash(f'Your Account has been created. You are now able to log in','success') # bootstrap class-success
